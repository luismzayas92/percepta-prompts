...
export default function Footer() {
  return (
    <footer className="border-t border-frost/[0.06] py-12">
      <Container className="flex flex-col items-center gap-4 text-center sm:flex-row sm:justify-between sm:text-left">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col leading-none">
            <span className="text-[11px] font-semibold tracking-[0.2em] text-haze">
              POWERED BY PERCEPTA
            </span>
            <span className="text-[9px] font-medium tracking-[0.16em] text-haze/50">
              DISEÑAMOS PERCEPCIÓN
            </span>
          </div>
        </div>
        <p className="text-xs text-haze/40">
